...
class com_amap_api_maps_model_RuntimeRemoteException extends java_lang_Object  {
  ...
  static Future<com_amap_api_maps_model_RuntimeRemoteException> create__String(String var1) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_model_RuntimeRemoteException__String', {"var1": var1});
  ...
  static Future<List<com_amap_api_maps_model_RuntimeRemoteException>> create_batch__String(List<String> var1) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_model_RuntimeRemoteException__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
