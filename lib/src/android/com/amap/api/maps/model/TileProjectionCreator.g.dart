...
class com_amap_api_maps_model_TileProjectionCreator extends java_lang_Object  {
  ...
  static Future<com_amap_api_maps_model_TileProjectionCreator> create__() async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_model_TileProjectionCreator__', );
  ...
  static Future<List<com_amap_api_maps_model_TileProjectionCreator>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_model_TileProjectionCreator__', {'length': length});
