...
class com_amap_api_maps_model_BaseOverlay extends java_lang_Object  {
  ...
  static Future<com_amap_api_maps_model_BaseOverlay> create__String(String var1) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_model_BaseOverlay__String', {"var1": var1});
  ...
  static Future<List<com_amap_api_maps_model_BaseOverlay>> create_batch__String(List<String> var1) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_model_BaseOverlay__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
