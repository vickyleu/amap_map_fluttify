...
class com_amap_api_maps_model_animation_AlphaAnimation extends com_amap_api_maps_model_animation_Animation  {
  ...
  static Future<com_amap_api_maps_model_animation_AlphaAnimation> create__float__float(double var1, double var2) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_model_animation_AlphaAnimation__float__float', {"var1": var1, "var2": var2});
  ...
  static Future<List<com_amap_api_maps_model_animation_AlphaAnimation>> create_batch__float__float(List<double> var1, List<double> var2) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_model_animation_AlphaAnimation__float__float', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__], "var2": var2[__i__]}]);
