...
class com_amap_api_maps_AMapException extends java_lang_Object  {
  ...
  static Future<com_amap_api_maps_AMapException> create__String(String var1) async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_AMapException__String', {"var1": var1});
    final object = com_amap_api_maps_AMapException()..refId = refId;
    return object;
  }
  
  static Future<com_amap_api_maps_AMapException> create__() async {
    final refId = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::createcom_amap_api_maps_AMapException__', );
    final object = com_amap_api_maps_AMapException()..refId = refId;
    return object;
  }
  ...
  static Future<List<com_amap_api_maps_AMapException>> create_batch__String(List<String> var1) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_AMapException__String', [for (int __i__ = 0; __i__ < var1.length; __i__++) {"var1": var1[__i__]}]);
  ...
  static Future<List<com_amap_api_maps_AMapException>> create_batch__(int length) async {
    ...
    final List resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('ObjectFactory::create_batchcom_amap_api_maps_AMapException__', {'length': length});
  ...
  Future<String> getErrorMessage() async {
    ...
    final __result__ = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('com.amap.api.maps.AMapException::getErrorMessage', {"__this__": this});
...
extension com_amap_api_maps_AMapException_Batch on List<com_amap_api_maps_AMapException> {
  ...
  Future<List<String>> getErrorMessage_batch() async {
    ...
    // invoke native method
    final resultBatch = await MethodChannel('me.yohom/amap_map_fluttify', StandardMethodCodec(FluttifyMessageCodec(tag: 'amap_map_fluttify'))).invokeMethod('com.amap.api.maps.AMapException::getErrorMessage_batch', [for (int __i__ = 0; __i__ < length; __i__++) {"__this__": this[__i__]}]);
